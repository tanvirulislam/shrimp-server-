        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.store') }}">Store</a></li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="name"><b>Store address</b></label>
                                <input type="text" class="form-control" id="name" value="{{$category->address}}"  name="address" placeholder="Enter Name">
