  ...
  <div class="container-fluid">
   <div class="row clearfix">
    <div class="col-lg-4 col-md-4 col-sm-4">
      ...
      <a href="{{ route('admin.banner.create') }}" type="button"  class="btn btn-raised btn-primary waves-effect" >Banner</a>
      @endif
    </div>
        ...
        <div class="body">
          ...
          <tbody>
            ...
            <td>
              ...
              <a class="btn btn-success text-white" href="{{ route('admin.banner.edit', $categories->id) }}"><i class="material-icons">build</i></a>
              @endif
              ...
              <form id="delete-form-{{ $categories->id }}" action="{{ route('admin.banner.delete',$categories->id) }}" method="POST" style="display: none;">
                @method('DELETE')
                @csrf
