        ...
        <div class="row">
                    ...
                    <ul class="category-menu">
                        ...
                        <li><a href="#">{{$cat_fish->name}}</a>
                            <ul class="sub-menu">
                                ...
                                <li><a
                                        href="{{route('product_details', $cat_product->product_slug)}}">{{$cat_product->name}}</a>
                                </li>
                                @endif
                                @endforeach
                            </ul>
            ...
            <div class="col-lg-9  order-2 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                    ...
                    <a style="background:transparent;" href="{{route('product_details', $cat_product->product_slug)}}">
                    ...
                    <!-- <div class="text-center w-100 pt-3">
                        <a href="{{route('cat_wise_all_product', $cat_fish->slug)}}"
