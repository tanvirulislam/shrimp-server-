            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="name"><b>stock (KG)</b></label>
                                <input type="text" class="form-control" id="name" name="stock" placeholder="Enter Name">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="exampleFormControlSelect1"><b>Date</b></label>
